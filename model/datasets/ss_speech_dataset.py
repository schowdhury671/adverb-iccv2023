...
class SoundSpacesSpeechDataset(Dataset):
    def __init__(self, split, normalize_whole=True, normalize_segment=False,
        ...
        self.split = split
        # if split == 'train':
        #     self.data_dir = '/fs/nexus-projects/audio-visual_dereverberation/visual-acoustic-matching/data/soundspaces_speech'
        # else:
        self.data_dir = os.path.join('/fs/nexus-projects/audio-visual_dereverberation/visual-acoustic-matching/data/soundspaces_speech', split)
    ...
    def __getitem__(self, item):
        ...
        # src_stft = torch.stft(torch.from_numpy(src_wav), 512, hop_length=10, win_length=25)
        # rec_stft = torch.stft(torch.from_numpy(rec_wav), 512, hop_length=10, win_length=25)
        ...
        # sample['src_stft'] = src_stft
        # rec_stft['rec_stft'] = rec_stft
