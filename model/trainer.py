...
import sys, os
sys.path.append('/fs/nexus-scratch/sanjoyc/visual-acoustic-matching/')
...
def run(args):
    ...
    if args.test or args.visualize:
        ...
        val_set = dataset(split='val-mini', use_rgb=True, use_depth=True, hop_length=args.hop_length,
